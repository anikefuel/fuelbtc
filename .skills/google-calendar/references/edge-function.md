...
const actions = {
  find_event: {
    url: "https://app-chwj03k1qold-api-connect-google-calendar-find-event.gateway.appmedo.com/",
    callers: "authenticated",
  },
  // Calendar metadata only — no event content.
  list_calendars: {
    url: "https://app-chwj03k1qold-api-connect-google-calendar-list-calendars.gateway.appmedo.com/",
    callers: "public",
  },
  list_events: {
    url: "https://app-chwj03k1qold-api-connect-google-calendar-list-events.gateway.appmedo.com/",
    callers: "authenticated",
  },
  create_event: {
    url: "https://app-chwj03k1qold-api-connect-google-calendar-create-event.gateway.appmedo.com/",
    callers: "authenticated",
  },
  update_event: {
    url: "https://app-chwj03k1qold-api-connect-google-calendar-update-event.gateway.appmedo.com/",
    callers: "authenticated",
  },
  delete_event: {
    url: "https://app-chwj03k1qold-api-connect-google-calendar-delete-event.gateway.appmedo.com/",
    callers: "authenticated",
  },
} as const;
```
...
```ts
const connectionEnv = "MEDO_CONNECT_GOOGLE_CALENDAR";
