...
|-------|-------|
| Method | `POST` |
| URL | `https://app-chwj03k1qold-api-zYkZzKQJrBdL.gateway.appmedo.com/image-generation/submit` |
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstream = await fetch(
    "https://app-chwj03k1qold-api-zYkZzKQJrBdL.gateway.appmedo.com/image-generation/submit",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
