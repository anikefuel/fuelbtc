...
| Item | Details |
|------|---------|
| Create Task Endpoint | `POST https://app-chwj03k1qold-api-GYX1bbkRQj4a.gateway.appmedo.com/v1/images/editing/expand` |
| Query Task (Single) Endpoint | `GET https://app-chwj03k1qold-api-AalZkkAG5w7L.gateway.appmedo.com/v1/images/editing/expand/{task_id}` |
| Query Task (List) Endpoint | `GET https://app-chwj03k1qold-api-pLVzAAkGZwDL.gateway.appmedo.com/v1/images/editing/expand` |
