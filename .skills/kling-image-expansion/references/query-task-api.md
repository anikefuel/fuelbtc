...
| Item | Details |
|------|---------|
| Endpoint | `GET https://app-chwj03k1qold-api-AalZkkAG5w7L.gateway.appmedo.com/v1/images/editing/expand/{task_id}` |
...
| Item | Details |
|------|---------|
| Endpoint | `GET https://app-chwj03k1qold-api-pLVzAAkGZwDL.gateway.appmedo.com/v1/images/editing/expand` |
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstream = await fetch(
    `https://app-chwj03k1qold-api-AalZkkAG5w7L.gateway.appmedo.com/v1/images/editing/expand/${task_id}`,
    {
      method: "GET",
      headers: {
