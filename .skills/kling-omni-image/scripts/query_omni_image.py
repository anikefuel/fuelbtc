#!/usr/bin/env python3
"""
Poll an already-submitted Kling omni-image task by task_id (does NOT submit a new task).

Use this when generate_omni_image.py returned {"status": "processing", "task_id": "..."}.
...
def main():
    """Entry point: poll an existing omni-image task and print the result JSON."""
    parser = argparse.ArgumentParser(description="Poll a Kling omni-image task.")
