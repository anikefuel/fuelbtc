...
**Endpoint:** `POST https://app-chwj03k1qold-api-2Y00Vzbe0MBY.gateway.appmedo.com/v1/images/omni-image`
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstream = await fetch(
    "https://app-chwj03k1qold-api-2Y00Vzbe0MBY.gateway.appmedo.com/v1/images/omni-image",
    {
      method: "POST",
      headers: {
