...
const actions = {
  find_files: {
    url: "https://app-chwj03k1qold-api-connect-google-drive-find-files.gateway.appmedo.com/",
    callers: "authenticated",
  },
  find_folder: {
    url: "https://app-chwj03k1qold-api-connect-google-drive-find-folder.gateway.appmedo.com/",
    callers: "authenticated",
  },
  get_file: {
    url: "https://app-chwj03k1qold-api-connect-google-drive-get-file.gateway.appmedo.com/",
    callers: "authenticated",
  },
  create_folder: {
    url: "https://app-chwj03k1qold-api-connect-google-drive-create-folder.gateway.appmedo.com/",
    callers: "authenticated",
  },
  create_text_file: {
    url: "https://app-chwj03k1qold-api-connect-google-drive-create-text.gateway.appmedo.com/",
    callers: "authenticated",
  },
  upload_from_url: {
    url: "https://app-chwj03k1qold-api-connect-google-drive-upload-url.gateway.appmedo.com/",
    callers: "authenticated",
  },
  download_file: {
    url: "https://app-chwj03k1qold-api-connect-google-drive-download-file.gateway.appmedo.com/",
    callers: "authenticated",
  },
  move_file: {
    url: "https://app-chwj03k1qold-api-connect-google-drive-move-file.gateway.appmedo.com/",
    callers: "authenticated",
  },
  copy_file: {
    url: "https://app-chwj03k1qold-api-connect-google-drive-copy-file.gateway.appmedo.com/",
    callers: "authenticated",
  },
  edit_file: {
    url: "https://app-chwj03k1qold-api-connect-google-drive-edit-file.gateway.appmedo.com/",
    callers: "authenticated",
  },
  trash_file: {
    url: "https://app-chwj03k1qold-api-connect-google-drive-trash-file.gateway.appmedo.com/",
    callers: "authenticated",
  },
} as const;
```
...
```ts
const connectionEnv = "MEDO_CONNECT_GOOGLE_DRIVE";
