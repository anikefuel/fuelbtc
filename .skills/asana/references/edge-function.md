...
const actions = {
  ...
  list_workspaces: {
    url: "https://app-chwj03k1qold-api-connect-asana-list-workspaces.gateway.appmedo.com/",
    callers: "authenticated",
  },
  list_projects: {
    url: "https://app-chwj03k1qold-api-connect-asana-list-projects.gateway.appmedo.com/",
    callers: "authenticated",
  },
  // Task names come from one reviewed workspace and optional project filters.
  search_tasks: {
    url: "https://app-chwj03k1qold-api-connect-asana-search-tasks.gateway.appmedo.com/",
    callers: "authenticated",
  },
  create_task: {
    url: "https://app-chwj03k1qold-api-connect-asana-create-task.gateway.appmedo.com/",
    callers: "authenticated",
  },
  update_task: {
    url: "https://app-chwj03k1qold-api-connect-asana-update-task.gateway.appmedo.com/",
    callers: "authenticated",
  },
} as const;
```
