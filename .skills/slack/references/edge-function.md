...
const actions = {
  ...
  find_channels: {
    url: "https://app-chwj03k1qold-api-connect-slack-find-channels.gateway.appmedo.com/",
    callers: "public",
  },
  // Free-text search across the workspace; there is no target to pin.
  search_messages: {
    url: "https://app-chwj03k1qold-api-connect-slack-search-messages.gateway.appmedo.com/",
    callers: "authenticated",
  },
  get_channel_history: {
    url: "https://app-chwj03k1qold-api-connect-slack-get-channel-history.gateway.appmedo.com/",
    callers: "authenticated",
  },
  send_message: {
    url: "https://app-chwj03k1qold-api-connect-slack-send-message.gateway.appmedo.com/",
    callers: "authenticated",
  },
} as const;
```
