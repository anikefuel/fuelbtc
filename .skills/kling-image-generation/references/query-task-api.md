...
| Item | Details |
|------|---------|
| Endpoint | `GET https://app-chwj03k1qold-api-M9v0wzOkZXGY.gateway.appmedo.com/v1/images/generations/{task_id}` |
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstream = await fetch(
    `https://app-chwj03k1qold-api-M9v0wzOkZXGY.gateway.appmedo.com/v1/images/generations/${taskId}`,
    {
      method: "GET",
      headers: {
