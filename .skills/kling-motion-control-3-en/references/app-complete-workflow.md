...
const CREATE_ENDPOINT =
  "https://app-chwj03k1qold-api-m9xKdopkqvMa.gateway.appmedo.com/motion-control/kling-3.0";
...
const QUERY_ENDPOINT = "https://app-chwj03k1qold-api-qYGWzQv1x4GY.gateway.appmedo.com/tasks";
