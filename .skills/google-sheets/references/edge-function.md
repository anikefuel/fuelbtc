...
const actions = {
  lookup_row: {
    url: "https://app-chwj03k1qold-api-connect-google-sheets-lookup-row.gateway.appmedo.com/",
    callers: "authenticated",
  },
  get_spreadsheet: {
    url: "https://app-chwj03k1qold-api-connect-google-sheets-get-spreadsheet.gateway.appmedo.com/",
    callers: "authenticated",
  },
  get_values: {
    url: "https://app-chwj03k1qold-api-connect-google-sheets-get-values.gateway.appmedo.com/",
    callers: "authenticated",
  },
  create_spreadsheet: {
    url: "https://app-chwj03k1qold-api-connect-google-sheets-create-spreadsheet.gateway.appmedo.com/",
    callers: "authenticated",
  },
  update_values: {
    url: "https://app-chwj03k1qold-api-connect-google-sheets-update-values.gateway.appmedo.com/",
    callers: "authenticated",
  },
  append_values: {
    url: "https://app-chwj03k1qold-api-connect-google-sheets-append-values.gateway.appmedo.com/",
    callers: "authenticated",
  },
  clear_values: {
    url: "https://app-chwj03k1qold-api-connect-google-sheets-clear-values.gateway.appmedo.com/",
    callers: "authenticated",
  },
} as const;
```
...
```ts
const connectionEnv = "MEDO_CONNECT_GOOGLE_SHEETS";
