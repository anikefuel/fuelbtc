...
- **Upstream**: `https://app-chwj03k1qold-api-w9Rb5Jdedqq9.gateway.appmedo.com/v1/search`
- **Gateway marker URL (rewritten per app)**: `POST https://app-chwj03k1qold-api-w9Rb5Jdedqq9.gateway.appmedo.com/v1/search`
