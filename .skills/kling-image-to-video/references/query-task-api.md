...
| Property | Value |
|----------|-------|
| **Endpoint** | `GET https://app-chwj03k1qold-api-rLobzpqX85m9.gateway.appmedo.com/v1/videos/image2video/{id}` |
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstream = await fetch(
    `https://app-chwj03k1qold-api-rLobzpqX85m9.gateway.appmedo.com/v1/videos/image2video/${taskId}`,
    {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
