...
const actions = {
  search_documents: {
    url: "https://app-chwj03k1qold-api-connect-google-docs-search-docs.gateway.appmedo.com/",
    callers: "authenticated",
  },
  get_document: {
    url: "https://app-chwj03k1qold-api-connect-google-docs-get-doc.gateway.appmedo.com/",
    callers: "authenticated",
  },
  get_plaintext: {
    url: "https://app-chwj03k1qold-api-connect-google-docs-get-text.gateway.appmedo.com/",
    callers: "authenticated",
  },
  create_document: {
    url: "https://app-chwj03k1qold-api-connect-google-docs-create-doc.gateway.appmedo.com/",
    callers: "authenticated",
  },
  copy_document: {
    url: "https://app-chwj03k1qold-api-connect-google-docs-copy-doc.gateway.appmedo.com/",
    callers: "authenticated",
  },
  append_markdown: {
    url: "https://app-chwj03k1qold-api-connect-google-docs-append-md.gateway.appmedo.com/",
    callers: "authenticated",
  },
  replace_all_text: {
    url: "https://app-chwj03k1qold-api-connect-google-docs-replace-text.gateway.appmedo.com/",
    callers: "authenticated",
  },
  replace_document: {
    url: "https://app-chwj03k1qold-api-connect-google-docs-replace-doc.gateway.appmedo.com/",
    callers: "authenticated",
  },
} as const;
```
...
```ts
const connectionEnv = "MEDO_CONNECT_GOOGLE_DOCS";
