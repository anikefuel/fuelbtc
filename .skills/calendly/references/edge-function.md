...
const actions = {
  // Connected identity and account structure are private by default.
  get_current_user: {
    url: "https://app-chwj03k1qold-api-connect-calendly-get-current-user.gateway.appmedo.com/",
    callers: "authenticated",
  },
  list_event_types: {
    url: "https://app-chwj03k1qold-api-connect-calendly-list-event-types.gateway.appmedo.com/",
    callers: "authenticated",
  },
  list_available_times: {
    url: "https://app-chwj03k1qold-api-connect-calendly-list-available-times.gateway.appmedo.com/",
    callers: "authenticated",
  },
  list_scheduled_events: {
    url: "https://app-chwj03k1qold-api-connect-calendly-list-scheduled-events.gateway.appmedo.com/",
    callers: "authenticated",
  },
  list_event_invitees: {
    url: "https://app-chwj03k1qold-api-connect-calendly-list-event-invitees.gateway.appmedo.com/",
    callers: "authenticated",
  },
  create_scheduling_link: {
    url: "https://app-chwj03k1qold-api-connect-calendly-create-scheduling-link.gateway.appmedo.com/",
    callers: "authenticated",
  },
  cancel_scheduled_event: {
    url: "https://app-chwj03k1qold-api-connect-calendly-cancel-scheduled-event.gateway.appmedo.com/",
    callers: "authenticated",
  },
} as const;
```
...
```ts
const connectionEnv = "MEDO_CONNECT_CALENDLY";
