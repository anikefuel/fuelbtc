...
**Endpoint**: `GET https://app-chwj03k1qold-api-wL1zlmgJGAlY.gateway.appmedo.com/data/3.0/onecall`
...
**Endpoint**: `GET https://app-chwj03k1qold-api-Aa2PZmgJq5OL.gateway.appmedo.com/data/3.0/onecall/timemachine`
...
**Endpoint**: `GET https://app-chwj03k1qold-api-2Y00zmgJ8lBY.gateway.appmedo.com/data/3.0/onecall/day_summary`
...
**Endpoint**: `GET https://app-chwj03k1qold-api-oYA6ZxVqenDa.gateway.appmedo.com/data/3.0/onecall/overview`
...
serve(async (req: Request): Promise<Response> => {
  ...
  const upstream = await fetch(
    `https://app-chwj03k1qold-api-wL1zlmgJGAlY.gateway.appmedo.com/data/3.0/onecall?${params}`,
    {
      method: "GET",
      headers: {
...
|----------|-------------------|---------------------|--------------|
| Historical weather for a timestamp | `weather-timemachine.ts` | `lat`, `lon`, `dt` | `https://app-chwj03k1qold-api-Aa2PZmgJq5OL.gateway.appmedo.com/data/3.0/onecall/timemachine` |
| Daily aggregated statistics | `weather-day-summary.ts` | `lat`, `lon`, `date` | `https://app-chwj03k1qold-api-2Y00zmgJ8lBY.gateway.appmedo.com/data/3.0/onecall/day_summary` |
| AI weather overview | `weather-overview.ts` | `lat`, `lon` | `https://app-chwj03k1qold-api-oYA6ZxVqenDa.gateway.appmedo.com/data/3.0/onecall/overview` |
