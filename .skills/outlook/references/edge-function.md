...
const actions = {
  search_messages: {
    url: "https://app-chwj03k1qold-api-connect-outlook-search-messages.gateway.appmedo.com/",
    callers: "authenticated",
  },
  get_message: {
    url: "https://app-chwj03k1qold-api-connect-outlook-get-message.gateway.appmedo.com/",
    callers: "authenticated",
  },
  // The caller chooses the recipient, so a public sender is an open relay.
  send_email: {
    url: "https://app-chwj03k1qold-api-connect-outlook-send-email.gateway.appmedo.com/",
    callers: "authenticated",
  },
  reply_email: {
    url: "https://app-chwj03k1qold-api-connect-outlook-reply-email.gateway.appmedo.com/",
    callers: "authenticated",
  },
  update_message: {
    url: "https://app-chwj03k1qold-api-connect-outlook-update-message.gateway.appmedo.com/",
    callers: "authenticated",
  },
  list_calendars: {
    url: "https://app-chwj03k1qold-api-connect-outlook-list-calendars.gateway.appmedo.com/",
    callers: "public",
  },
  list_events: {
    url: "https://app-chwj03k1qold-api-connect-outlook-list-events.gateway.appmedo.com/",
    callers: "authenticated",
  },
  find_event: {
    url: "https://app-chwj03k1qold-api-connect-outlook-find-event.gateway.appmedo.com/",
    callers: "authenticated",
  },
  get_schedule: {
    url: "https://app-chwj03k1qold-api-connect-outlook-get-schedule.gateway.appmedo.com/",
    callers: "authenticated",
  },
  create_event: {
    url: "https://app-chwj03k1qold-api-connect-outlook-create-event.gateway.appmedo.com/",
    callers: "authenticated",
  },
  update_event: {
    url: "https://app-chwj03k1qold-api-connect-outlook-update-event.gateway.appmedo.com/",
    callers: "authenticated",
  },
  delete_event: {
    url: "https://app-chwj03k1qold-api-connect-outlook-delete-event.gateway.appmedo.com/",
    callers: "authenticated",
  },
} as const;
```
...
```ts
const connectionEnv = "MEDO_CONNECT_OUTLOOK";
