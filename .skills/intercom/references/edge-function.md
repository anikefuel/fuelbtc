...
const actions = {
  list_conversations: {
    url: "https://app-chwj03k1qold-api-connect-intercom-list-conversations.gateway.appmedo.com/",
    callers: "authenticated",
  },
  search_conversations: {
    url: "https://app-chwj03k1qold-api-connect-intercom-search-conversations.gateway.appmedo.com/",
    callers: "authenticated",
  },
  get_conversation: {
    url: "https://app-chwj03k1qold-api-connect-intercom-get-conversation.gateway.appmedo.com/",
    callers: "authenticated",
  },
  create_conversation: {
    url: "https://app-chwj03k1qold-api-connect-intercom-create-conversation.gateway.appmedo.com/",
    callers: "authenticated",
  },
  reply_conversation: {
    url: "https://app-chwj03k1qold-api-connect-intercom-reply-conversation.gateway.appmedo.com/",
    callers: "authenticated",
  },
  close_conversation: {
    url: "https://app-chwj03k1qold-api-connect-intercom-close-conversation.gateway.appmedo.com/",
    callers: "authenticated",
  },
  reopen_conversation: {
    url: "https://app-chwj03k1qold-api-connect-intercom-reopen-conversation.gateway.appmedo.com/",
    callers: "authenticated",
  },
  tag_conversation: {
    url: "https://app-chwj03k1qold-api-connect-intercom-tag-conversation.gateway.appmedo.com/",
    callers: "authenticated",
  },
  list_contacts: {
    url: "https://app-chwj03k1qold-api-connect-intercom-list-contacts.gateway.appmedo.com/",
    callers: "authenticated",
  },
  search_contacts: {
    url: "https://app-chwj03k1qold-api-connect-intercom-search-contacts.gateway.appmedo.com/",
    callers: "authenticated",
  },
  get_contact: {
    url: "https://app-chwj03k1qold-api-connect-intercom-get-contact.gateway.appmedo.com/",
    callers: "authenticated",
  },
  get_contact_by_external_id: {
    url: "https://app-chwj03k1qold-api-connect-intercom-get-contact-ext-id.gateway.appmedo.com/",
    callers: "authenticated",
  },
  create_contact: {
    url: "https://app-chwj03k1qold-api-connect-intercom-create-contact.gateway.appmedo.com/",
    callers: "authenticated",
  },
  update_contact: {
    url: "https://app-chwj03k1qold-api-connect-intercom-update-contact.gateway.appmedo.com/",
    callers: "authenticated",
  },
  tag_contact: {
    url: "https://app-chwj03k1qold-api-connect-intercom-tag-contact.gateway.appmedo.com/",
    callers: "authenticated",
  },
  list_companies: {
    url: "https://app-chwj03k1qold-api-connect-intercom-list-companies.gateway.appmedo.com/",
    callers: "authenticated",
  },
  get_company: {
    url: "https://app-chwj03k1qold-api-connect-intercom-get-company.gateway.appmedo.com/",
    callers: "authenticated",
  },
  create_or_update_company: {
    url: "https://app-chwj03k1qold-api-connect-intercom-upsert-company.gateway.appmedo.com/",
    callers: "authenticated",
  },
  search_tickets: {
    url: "https://app-chwj03k1qold-api-connect-intercom-search-tickets.gateway.appmedo.com/",
    callers: "authenticated",
  },
  get_ticket: {
    url: "https://app-chwj03k1qold-api-connect-intercom-get-ticket.gateway.appmedo.com/",
    callers: "authenticated",
  },
  create_ticket: {
    url: "https://app-chwj03k1qold-api-connect-intercom-create-ticket.gateway.appmedo.com/",
    callers: "authenticated",
  },
  update_ticket: {
    url: "https://app-chwj03k1qold-api-connect-intercom-update-ticket.gateway.appmedo.com/",
    callers: "authenticated",
  },
  reply_ticket: {
    url: "https://app-chwj03k1qold-api-connect-intercom-reply-ticket.gateway.appmedo.com/",
    callers: "authenticated",
  },
  list_ticket_types: {
    url: "https://app-chwj03k1qold-api-connect-intercom-list-ticket-types.gateway.appmedo.com/",
    callers: "authenticated",
  },
  list_ticket_states: {
    url: "https://app-chwj03k1qold-api-connect-intercom-list-ticket-states.gateway.appmedo.com/",
    callers: "authenticated",
  },
  list_articles: {
    url: "https://app-chwj03k1qold-api-connect-intercom-list-articles.gateway.appmedo.com/",
    callers: "authenticated",
  },
  search_articles: {
    url: "https://app-chwj03k1qold-api-connect-intercom-search-articles.gateway.appmedo.com/",
    callers: "authenticated",
  },
  get_article: {
    url: "https://app-chwj03k1qold-api-connect-intercom-get-article.gateway.appmedo.com/",
    callers: "authenticated",
  },
  list_help_centers: {
    url: "https://app-chwj03k1qold-api-connect-intercom-list-help-centers.gateway.appmedo.com/",
    callers: "authenticated",
  },
  list_admins: {
    url: "https://app-chwj03k1qold-api-connect-intercom-list-admins.gateway.appmedo.com/",
    callers: "authenticated",
  },
  list_tags: {
    url: "https://app-chwj03k1qold-api-connect-intercom-list-tags.gateway.appmedo.com/",
    callers: "authenticated",
  },
  get_counts: {
    url: "https://app-chwj03k1qold-api-connect-intercom-get-counts.gateway.appmedo.com/",
    callers: "authenticated",
  },
  list_data_events: {
    url: "https://app-chwj03k1qold-api-connect-intercom-list-data-events.gateway.appmedo.com/",
    callers: "authenticated",
  },
  create_data_event: {
    url: "https://app-chwj03k1qold-api-connect-intercom-create-data-event.gateway.appmedo.com/",
    callers: "authenticated",
  },
} as const;
```
...
```ts
const connectionEnv = "MEDO_CONNECT_INTERCOM";
