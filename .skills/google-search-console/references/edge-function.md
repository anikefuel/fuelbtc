...
const actions = {
  list_sites: {
    url: "https://app-chwj03k1qold-api-connect-google-search-console-list-sites.gateway.appmedo.com/",
    callers: "authenticated",
  },
  get_site: {
    url: "https://app-chwj03k1qold-api-connect-google-search-console-get-site.gateway.appmedo.com/",
    callers: "authenticated",
  },
  search_analytics_query: {
    url: "https://app-chwj03k1qold-api-connect-google-search-console-search-query.gateway.appmedo.com/",
    callers: "authenticated",
  },
  inspect_url: {
    url: "https://app-chwj03k1qold-api-connect-google-search-console-inspect-url.gateway.appmedo.com/",
    callers: "authenticated",
  },
  list_sitemaps: {
    url: "https://app-chwj03k1qold-api-connect-google-search-console-list-sitemap.gateway.appmedo.com/",
    callers: "authenticated",
  },
  get_sitemap: {
    url: "https://app-chwj03k1qold-api-connect-google-search-console-get-sitemap.gateway.appmedo.com/",
    callers: "authenticated",
  },
  submit_sitemap: {
    url: "https://app-chwj03k1qold-api-connect-google-search-console-send-sitemap.gateway.appmedo.com/",
    callers: "authenticated",
  },
  add_site: {
    url: "https://app-chwj03k1qold-api-connect-google-search-console-add-site.gateway.appmedo.com/",
    callers: "authenticated",
  },
} as const;
```
...
```ts
const connectionEnv = "MEDO_CONNECT_GOOGLE_SEARCH_CONSOLE";
